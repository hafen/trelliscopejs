...
d <- housing %>%
  ...
  summarise(
    ...
    med_list = cog(mean(medListPriceSqft, na.rm = TRUE), desc = "median list price / sq ft"),
    med_sold = cog(mean(medSoldPriceSqft, na.rm = TRUE), desc = "median sold price / sq ft"),
...
For those who are interested, trelliscopejs-lib is written using [React](https://facebook.github.io/react/), [redux](http://redux.js.org/), and [Webpack](https://webpack.github.io/). Other major components include [material-ui](http://www.material-ui.com/#/) and [crossfilter](https://www.npmjs.com/package/crossfilter2).
...
<script>
  (function() {
    trelliscopeApp('ebbfa969', 'http://hafen.github.io/trelliscopejs-demo/mpg/appfiles/config.jsonp');
    trelliscopeApp('32b2482a', 'http://hafen.github.io/trelliscopejs-demo/gapminder/appfiles/config.jsonp');
    trelliscopeApp('8a43f2dd', 'http://hafen.github.io/trelliscopejs-demo/housing/appfiles/config.jsonp');
  })();
</script>

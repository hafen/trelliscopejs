...
The **trelliscopejs** R package is an interface for creating Trelliscope displays with the goal of providing methods that are convenient to use in traditional visual / analytical workflows. For example, the package provides methods that allow you to easily generate Trelliscope displays from ggplot2 or ["tidy"](https://blog.rstudio.com/2016/09/15/tidyverse-1-0-0/) workflows.
...
In addition to `facet_trelliscope()`, this package comes with a more generic `trelliscope()` method that fits naturally into ["tidy"](https://blog.rstudio.com/2016/09/15/tidyverse-1-0-0/) workflows involving dplyr / tidyr / purrr / etc.
...
For those who are interested, trelliscopejs-lib is written using [React](https://reactjs.org/), [redux](https://redux.js.org/), and [Webpack](https://webpack.github.io/). Other major components include [material-ui](https://www.material-ui.com/) and [crossfilter](https://www.npmjs.com/package/crossfilter2), and [d3](https://d3js.org/).
